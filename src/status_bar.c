...
create_status_bar(void)
{
    ...
    wbkgd(status_bar, theme_statusbartext());
    wattron(status_bar, theme_statusbarbrackets());
    mvwprintw(status_bar, 0, cols - 29, _active);
    wattroff(status_bar, theme_statusbarbrackets());
...
status_bar_new(const int win)
{
    ...
    wattron(status_bar, theme_statusbarnew());
    wattron(status_bar, A_BLINK);
    if (win < 9)
        mvwprintw(status_bar, 0, cols - 29 + active_pos, "%d", win+1);
    else
        mvwprintw(status_bar, 0, cols - 29 + active_pos, "10");
    wattroff(status_bar, theme_statusbarnew());
